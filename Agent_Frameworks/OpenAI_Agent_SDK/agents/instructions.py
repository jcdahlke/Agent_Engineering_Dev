...
Keeping prompts in a dedicated module makes them easy to tune without touching
agent construction logic or tool definitions.
"""
...
into a structured, insightful analysis before handing off to the Writer.
...
research report from the Analyzer's synthesis.
...
Review process:
  ...
  4. If quality_score < 7.0 AND revisions remain:
       ...
       - List exactly what needs to be improved (e.g., "Add more statistics to
         the Key Findings section", "Expand the Conclusion").
